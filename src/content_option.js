...
const meta = {
  title: "Noah Pursell | Software Engineer",
  description:
    "Software engineer and Computer Science graduate student building production systems across web, mobile, cloud, and applied AI.",
};

const introdata = {
  title: "I’m Noah Pursell",
  animated: {
    first: "I build software that solves real problems",
    second: "I design systems from architecture to production",
    third: "I apply AI where it creates meaningful value",
  },
  description:
    "I’m a software engineer and Computer Science graduate student at OU with experience building production web, mobile, cloud, and AI systems for public safety, energy, and veterinary technology.",
...
const dataabout = {
  title: "About Me",
  aboutme:
    "I’m a software engineer and Computer Science graduate student at the University of Oklahoma, graduating in December 2026. At GeoSafe, I helped architect a public-safety dispatch platform, designed and built a JSON-driven form system with iOS and web renderers, shipped production Android Auto features, and modernized the company’s CI/CD process. I’ve also developed AI-powered applications at ConocoPhillips and Inventory Ally. I enjoy working across the stack—from system architecture and backend services to web and mobile applications—and using the right technologies to solve meaningful problems.",
};
...
const skills = [
  {
    category: "Languages",
    items: "C#, Python, TypeScript, JavaScript, Kotlin, Swift, C++, Java, SQL",
  },
  {
    category: "Web & Backend",
    items:
      ".NET, ASP.NET Core, React, Vite, Node.js, FastAPI, Flask, REST APIs",
  },
  {
    category: "Mobile",
    items: "Android, iOS, SwiftUI, Android Auto, CarPlay",
  },
  {
    category: "AI & Machine Learning",
    items:
      "PyTorch, TensorFlow/Keras, Scikit-learn, Pandas, NumPy, LLMs, RAG, LangGraph, LangChain",
  },
  {
    category: "Cloud & Data",
    items:
      "Azure, AWS, PostgreSQL, SQLite, Elasticsearch, Azure AI Search, Azure Service Bus",
  },
  {
    category: "Architecture & DevOps",
    items:
      "Clean Architecture, Event Sourcing, Docker, Git, GitHub Actions, CI/CD, Automated Testing, Terraform",
  },
];

const awards = [
  "Microsoft Azure Fundamentals, Microsoft Azure AI Fundamentals, Mendix Rapid Developer",
  "2025 Hacklahoma Built on Ethereum Award; 2024 and 2023 Hacklahoma 2nd Place",
  "2024 and 2023 OU AI Symposium 1st Place",
  "2024 AGRI AI Competition 3rd Place",
  "Dean’s Honor Roll (2023, 2024, Spring 2025)",
];
...
const dataportfolio = [
  {
    ...
    description:
      "An online demo explaining how artificial neural networks (ANNs) work for a kids summer STEM camp.",
  ...
  },
  {
    ...
    description:
      "A longitudinal dataset of torrents matched to IMDb movies and shows. Published on arXiv.",
  ...
  },
  {
    ...
    description:
      "Study analyzing privacy concerns in email marketing across online services. Published on arXiv.",
  ...
  },
  {
    ...
    description:
      "A platform that generates print-ready AI art products from minimal user input. Published on arXiv.",
  ...
  },
  {
    ...
    description:
      "A data science project identifying climate drivers of Oklahoma prairie phenology. AGRI AI 2024 winner.",
  ...
  },
  {
    ...
    description:
      "A consumer-facing platform enabling AI-powered art selling between individuals. Built at Shuffle.Ink.",
  ...
  },
  {
    ...
    description:
      "Personal home server setup for hosting websites and services like this portfolio.",
  ...
  },
  {
    ...
    description:
      "AI Symposium 2024 project: Chat and receive AI-generated video responses from SpongeBob characters.",
  ...
  },
  {
    ...
    description:
      "Hacklahoma 2024 project using AI to recommend college resources and planning tools for students.",
  ...
  },
  {
    ...
    description:
      "Hacklahoma 2025: Decentralized system for collaborative AI image moderation using blockchain.",
  ...
  },
  {
    ...
    description:
      "Ethereum project for lending, renting, and managing digital goods and licenses.",
  ...
  },
  {
    ...
    description:
      "React portfolio website hosted on AWS S3 with CloudFront CDN and automated CI/CD pipeline using GitHub Actions.",
...
const projectDescriptions = {
  ...
  "magnet-db": [
    ...
    },
    {
      type: "text",
      content:
        "My role focused on mapping torrent entries to IMDb records. I initially experimented with vector embeddings and vector databases, but due to performance issues, I pivoted to using torrent name parsers and Elasticsearch for more efficient matching.",
    },
    {
      type: "link",
  ...
  "on-demand-ai-art": [
    {
      type: "heading",
      content:
        "On-Demand AI Art: Print-Ready Image Generation with Minimal Input",
    },
    {
      type: "summary",
    },
  ...
  "home-server": [
    ...
    },
    {
      type: "text",
      content:
        "This project showcases a self-hosted infrastructure for running personal web applications from my home computer using virtual machines and containerization.",
    },
    {
      type: "text",
      content:
  ...
  spongebot: [
    ...
    },
    {
      type: "text",
      content:
        "SpongeBot is an AI-powered chatbot platform that lets users interact with animated versions of SpongeBob and Patrick (via their Actor's) through real-time, voice-driven conversations. The system combines large language models, voice conversion, and video synthesis in a Snapchat-style interface to create a novel AI experience.",
    },
    {
      type: "text",
      content:
        "We built SpongeBot using a modular microservice architecture. I worked on integrating Whisper for speech-to-text, OpenAI GPT-4 for dialogue generation, Retrieval-Based Voice Conversion for character-specific speech, and SadTalker for video generation. These services were hosted locally and stitched together using Flask APIs and a React frontend. I also implemented GPU load management and parallelized audio/video generation to maximize responsiveness.",
    },
    {
      type: "link",
  ...
  "back-to-the-books": [
    ...
    },
    {
      type: "text",
      content:
        "Back to the Books is a full-stack AI-powered web app that enhances student learning by connecting to their Canvas Learning Management System (LMS) data and generating personalized study aids. It creates active-recall-based flashcards and hosts a tutor chatbot that responds based on real class materials.",
    },
    {
      type: "text",
      content:
    ...
    },
    {
      type: "text",
      content:
        "This project won 2nd place at the 2024 Hacklahoma Hackathon and demonstrated the potential for AI to deeply personalize the educational experience.",
    },
    {
      type: "video",
  ...
  limelend: [
    ...
    },
    {
      type: "text",
      content:
        "LimeLend is a decentralized platform that enables users to buy, lend, and rent digital games using Ethereum smart contracts. The system replaces centralized DRM with trustless on-chain ownership and billing, allowing fair revenue sharing between developers and users.",
    },
    {
      type: "text",
      content:
  ...
  "portfolio-website": [
    ...
    },
    {
      type: "text",
      content:
        "This portfolio website is built with React and showcases my projects, experience, and skills. It demonstrates modern web development practices combined with cloud infrastructure and automated deployment pipelines.",
    },
    {
      type: "text",
      content:
    ...
    },
    {
      type: "text",
      content:
        "The architecture includes S3 for static hosting, CloudFront for caching and SSL termination, and GitHub Actions for continuous integration and deployment. This setup provides a scalable, secure, and cost-effective solution for hosting modern web applications.",
    },
  ],
};
...
const contactConfig = {
  ...
  description:
    "I am always interested in learning from others, hearing about new opportunities, and sharing what I know. Feel free to email or text me. I will generally respond within one business day.",
